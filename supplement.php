    ...
    <div class="site-section">
        <div class="container">
          <div class="row">
            ...
            <h2 class="text-black text-center">Supplements</h2>
              <div class="border text-center">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
                <img src="./images/supplement.jfif" alt="Image" class="img-fluid p-4">
              </div>
              </div>
              <div class="col-sm-12">
              <p>
